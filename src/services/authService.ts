...
export const signInUser = async (email: string, pass: string): Promise<UserCredential> => {
  return await signInWithEmailAndPassword(auth, email, pass);
};

export const signUpUser = async (email: string, pass: string): Promise<UserCredential> => {
